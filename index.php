...
<body>
    <div class="session">
        ...
        <form action="action/login.php" method="POST" class="log-in" autocomplete="off">
            <h4>Prueba <span>Login</span></h4>
            <p>Welcome back! Log in to your account to view today's clients:</p>
            <div class="floating-label">
                <input placeholder="Correo electrónico" type="text" name="email" id="email" autocomplete="off">
            ...
            <div class="floating-label">
                <input placeholder="Número telefónico" type="text" name="phone" id="phone" autocomplete="off">
